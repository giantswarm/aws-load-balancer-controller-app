...
- Shorten charts names to `aws-lb-controller` and `aws-lb-controller-bundle`
...
[Unreleased]: https://github.com/giantswarm/aws-load-balancer-controller-app/compare/v3.0.0...HEAD
